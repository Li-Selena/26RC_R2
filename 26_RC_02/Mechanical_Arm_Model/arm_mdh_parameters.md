...
For a clean MDH table, define the MDH base frame `{0}` as a rotated copy of the
robot frame:
...
```text
theta1 = 0: joint2 is at robot (0, 42.64, 98.18)
theta2 = 0: the joint2-to-joint3 endpoint chord points along +Y_robot
...
| 2 | joint2 roll | +90 | 42.64 | theta2 | 0 | z2 is the roll axis; at theta1=0 it points along +X_robot |
...
+Y_link: convex side of the link in the OYZ plane
+Z_link: roll axis direction, +X_robot at theta1=theta2=0
```

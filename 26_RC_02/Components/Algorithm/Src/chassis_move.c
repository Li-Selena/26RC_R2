                            ...
                            const MecanumParam_t *param)
{
    ...
    /* 累加到世界坐标系起点 */
    ctrl->odom_x   = ctrl->start_odom_x   + delta.vx;
    ctrl->odom_y   = ctrl->start_odom_y   + delta.vy;
                                       ...
                                       float dt, float now_sec)
{
    ...
    /* ── 位置误差 ── */
    err_x   = ref_x   - (ctrl->odom_x   - ctrl->start_odom_x);
    err_y   = ref_y   - (ctrl->odom_y   - ctrl->start_odom_y);

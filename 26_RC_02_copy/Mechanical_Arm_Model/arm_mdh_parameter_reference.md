...
`X4=+X0` and `Z4=+Z0`; after motion, frame 4 follows joint3 rotation through
...
At the zero pose, frame `{4}` has the same axis directions as frame `{0}` and:

```text
O4 = (0, 42.64, 482.109445)
```
...
| tool point | x0 | y0 | z0 |
|---|---:|---:|---:|
| suction cup 1 | 0 | -4.15 | 527.609445 |
| suction cup 2 | 0 | 135.24 | 482.109445 |

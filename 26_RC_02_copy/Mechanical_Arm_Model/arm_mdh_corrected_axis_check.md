...
| pair | check | result |
|---|---|---|
| z1 to z2 | `z1=+Z0`, `z2=+X0`; common normal is `+/-Y0` | `x1=+Y0` is valid |
| z2 to z3 | `z2` and `z3` are parallel `+X0`; J2-to-J3 separation is `+Z0` | `x2=+Z0` is valid |
| z3 to z4 | `z3=+X0`, `z4=+Z0`; axes intersect at J3/J4 | `x3=-Y0` is valid |
...
`z4=+Z0` and `x4=+X0`; after motion, frame `{4}` follows joint3 rotation.

...
CLIMB_UPSTAIRS_STEP_NAMES = [
    ...
    "STEP_09_ALL_DRIVE_FORWARD_500",
    "STEP_10_ALL_DRIVE_FORWARD_30_X9",
    "STEP_11_ALL_LEGS_ZERO",
    "STEP_12_ALL_LEGS_DOWN_10_X2",
    "STEP_13_CHASSIS_FORWARD_100_X2",
]
...
IK_STATUS = {0: "OK", 1: "NULL", 2: "BAD_PARAM", 3: "HEIGHT_UNREACHABLE", 4: "JOINT_LIMIT"}
IK_REASON = {
    0: "NONE",
    1: "BAD_TOOL",
    2: "BAD_STATE",
...
def _decode_arm_status(p: bytes) -> Dict[str, Any]:
    ...
    data: Dict[str, Any] = {
        ...
        "error_flags": _flags(
            error_flags,
            ["ik", "joint_limit", "height_unreachable", "bad_param"],
        ),
        "ik_status": ik,
        ...
        "tool_state_name": TOOL_STATE.get(tool_state, "UNKNOWN"),
...
def _decode_robot_status(p: bytes) -> Dict[str, Any]:
    ...
    pos_state = _u8(p, 94)
    executing_names = (
        ["chassis_moving", "chassis_pos_running", "reserved2", "reserved3", "climb_motor_active", "yaw_tune_running", "arm_active", "any"]
        if protocol_version >= 2
        else ["chassis_moving", "chassis_pos_running", "arm_active", "reserved3", "any"]
    )
    data: Dict[str, Any] = {
        ...
        data["arm"].update(
            {
                ...
                "theta_rad": [_f32(p, 200), _f32(p, 204), _f32(p, 208)],
                "tool_world_mm": [_f32(p, 212), _f32(p, 216), _f32(p, 220)],
                "last_update_ms": _u32(p, 224),
                "output_apply_count": _u32(p, 228),
                "tool": _u8(p, 232),
                "tool_name": TOOL_DEV.get(_u8(p, 232), "UNKNOWN"),
                "tool_state": _u8(p, 233),
                "tool_state_name": TOOL_STATE.get(_u8(p, 233), "UNKNOWN"),
            }
        )
        ...
        data.update(
            {
                ...
                "tool_state": _u8(p, 3),
                "tool_state_name": TOOL_STATE.get(_u8(p, 3), "UNKNOWN"),

    ...
    def _handle_line(self, line: str) -> bool:
        ...
        try:
            ...
            if op == "help":
                ...
                values = self._need_floats(args, 2, "tool_s1 Z_MM YAW_RAD")
                self._write(build_usb_command("TOOL_SET_MODE", [0.0, 1.0, values[0], values[1]]))
            elif op == "tool_s2":
                ...
                self._write(build_usb_command("TOOL_SET_MODE", [2.0, 1.0, values[0], values[1]]))
            elif op == "tool_stow":
        ...
        print(
            "\n".join(
                [
                    ...
                    "arm_enable | arm_disable | arm_target TOOL STATE Z_MM YAW_RAD | arm_stop | arm_status",
                    "tool_enable | tool_target TOOL STATE Z_MM YAW_RAD | tool_s1/tool_s2/tool_gripper Z_MM YAW_RAD | tool_stow TOOL Z_MM YAW_RAD | tool_status",

 ...
 * FDCAN1/FDCAN2 each reserve M1..M6 for M3508 feedback and current control.
 * M1..M4 use command ID 0x200; M5..M8 use command ID 0x1FF.
 */
typedef enum
{
...
extern motor_measure_t motor_fdcan1[8];  /* FDCAN1 M3508: [0..5] = ID 0x201..0x206 */
extern motor_measure_t motor_fdcan2[8];  /* FDCAN2 M3508: [0..5] = ID 0x201..0x206 */

                              ...
                              float *world_y)
{
    ...
    arm_sin_cos_f32(yaw_rad * INS_NAV_RAD2DEG_F, &sin_yaw, &cos_yaw);

    *world_x = robot_x * cos_yaw - robot_y * sin_yaw;
    *world_y = robot_x * sin_yaw + robot_y * cos_yaw;
}
                              ...
                              float *robot_y)
{
    ...
    *robot_x =  world_x * cos_yaw + world_y * sin_yaw;
    *robot_y = -world_x * sin_yaw + world_y * cos_yaw;
}
